...
function Footer() {
  return (
    <footer className="flex flex-col min-h-[10vh] relative bg-stone-950 text-slate-200 ">
      <div className="border-t border-gray-600 flex flex-col sm:flex-row justify-between px-6 sm:px-12 py-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 w-full">
          ...
          <p className="text-sm sm:ml-auto text-gray-400 mt-4 sm:mt-0">© Yevhenii Solomchenko, Inc. 2024. All Rights Reserved.</p>
        </div>

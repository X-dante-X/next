  ...
  return (
    <div className="flex flex-col items-center w-full max-w-lg mx-auto mt-2">
      <label
        ...
        className="flex flex-col items-center w-full p-5 text-center bg-white border-2 border-gray-300 border-dashed cursor-pointer dark:bg-gray-900 dark:border-gray-700 rounded-xl"
      >
        <svg
